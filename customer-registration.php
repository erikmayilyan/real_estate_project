...
if (isset($_POST['form_submit'])) {
  try {
    ...
    $statement = $conn->prepare("INSERT INTO customers (full_name, email, photo, password, token, status) VALUES (?, ?, ?, ?, ?, ?)");
    ...
    //$success_message = "Registration is successful! Check your email and verify your registration";
        ...
        <div class="row justify-content-center">
            <div class="col-xl-4 col-lg-5 col-md-6 col-sm-12">
                <div class="login-form">
                    ...
                    <div class="mb-3">
                        <a href="<?php echo BASE_URL; ?>customer-login.php" class="primary-color">Existing User? Login Now</a>
                    </div>
                </div>
            </div>
        </div>
