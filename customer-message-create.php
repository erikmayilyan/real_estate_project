...
if (isset($_POST['form_submit'])) {
  try {
    ...
    $email_message = 'Customer '.$_SESSION['customer']['full_name'].' has sent you message. So please login to your account and click on this link: <br>';
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-9 col-md-12">
                <a href="<?php echo BASE_URL; ?>customer-messages" class="btn btn-primary btn-sm mb_20">
                    All Messages
                </a>
                <form action="" method="post">
                    <div class="row">
                        ...
                        <div class="col-md-12 mb-3">
                            ...
                            <div class="form-group">
                                <textarea name="message" class="form-controls editor" id="" cols="30" rows="10"></textarea>
                            </div>
                        </div>
                        <div class="col-md-6 mb-3">
                            ...
                            <div class="form-group">
                                <select name="agent_id" class="form-select">
                                    <?php 
                                    $statement = $conn->prepare("SELECT * FROM agents WHERE status=? ORDER BY full_name ASC");
                                    $statement->execute([1]);
                                    $result = $statement->fetchAll(PDO::FETCH_ASSOC);
                                    foreach ($result as $row) {
                                    ?>
                                        <option value="<?php echo $row['id']; ?>">
                                            <?php echo $row['full_name'].' - '.$row['email']; ?>
                                        </option>
                                    <?php
                                    };
                                    ?>
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                <input name="form_submit" type="submit" class="btn btn-primary" value="Send">
                            </div>
                        </div>
                    </div>
                </form>
