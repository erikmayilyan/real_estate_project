...
if (isset($_POST['form_update'])) {
  try {
    ...
    $statement = $conn->prepare('UPDATE agents SET 
                                  full_name=?, 
                                  email=?, 
                                  company=?, 
                                  biography=?,
                ...
                <form action="" method="post" enctype="multipart/form-data">
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <div class="form-group">
                                <input type="text" name="designation" class="form-control" value="<?php echo isset($_SESSION['agent']['designation']) ? $_SESSION['agent']['designation'] : ''; ?>">
                            </div>
                        </div>
                        <div class="col-md-12 mb-3">
                            <label for="">Biography</label>
                            <textarea name="biography" class="form-control editor" cols="30" rows="10">
                              <?php echo $_SESSION['agent']['biography']; ?>
                            </textarea>
                        </div>
                        <div class="col-md-6 mb-3">
