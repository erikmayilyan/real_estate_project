                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered" id="example1">
                                ...
                                <tbody>
                                    <?php
                                      $i = 0;
                                      $statement = $conn->prepare("SELECT * FROM agents ORDER BY full_name ASC");
                                      $statement->execute();
                                      ...
                                      foreach ($result as $row) {
                                        ...
                                        <tr>
                                          ...
                                          <td class="pt_10 pb_10">
                                              ...
                                              <a href="<?php echo ADMIN_URL; ?>agent-delete.php?id=<?php echo $row['id']; ?>" class="btn btn-danger btn-sm" onClick="return confirm('Are you sure?');">
                                                  ...
                                                  <div class="modal-dialog modal-lg">
                                                      <div class="modal-content">
                                                          ...
                                                          <div class="modal-body">
                                                              ...
                                                              <div class="form-group row bdb1 pt_10 mb_0">
                                                                  <div class="col-md-4">
                                                                      <label class="form-label">Facebooj: </label>
                                                                  </div>
                                                                  <div class="col-md-8">
