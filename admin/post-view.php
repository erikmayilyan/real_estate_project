                                      ...
                                      foreach ($result as $row) {
                                        ...
                                        <tr>
                                          ...
                                          <td class="pt_10 pb_10">
                                              <a href="<?php echo ADMIN_URL; ?>post-edit.php?id=<?php echo $row['id']; ?>" class="btn btn-primary btn-sm">
                                                <i class="fas fa-edit"></i>
                                              </a>
                                              <a href="<?php echo ADMIN_URL; ?>post-delete.php?id=<?php echo $row['id']; ?>" class="btn btn-danger btn-sm" onClick="return confirm('Are you sure?');">
