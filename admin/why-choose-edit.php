...
if (isset($_POST['form_submit'])) {
  try {
    ...
    $statement->execute([$_POST['heading'], $_POST['text'], $_POST['icon'], $_REQUEST['id']]);
                          ...
                          <form action="" method="post">
                              <div class="form-group mb-3">
                                  ...
                                  <input 
                                    ...
                                    name="heading" 
                                    autocomplete="off"
                                    value="<?php echo $result[0]['heading']; ?>"
                                  >
                              </div>
                              <div class="form-group mb-3">
                                  <label>Text *</label>
