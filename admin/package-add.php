...
if (isset($_POST['form_submit'])) {
  try {
    ...
    $statement = $conn->prepare("INSERT INTO packages (name, price, 
    allowed_days, allowed_properties, allowed_featured_properties,
    allowed_photos, allowed_videos) VALUES (?, ?, ?, ?, ?, ?, ?)");

    $statement->execute(array($_POST['name'], $_POST['price'], $_POST['allowed_days'], $_POST['allowed_properties'],
    $_POST['allowed_featured_properties'], $_POST['allowed_photos'], $_POST['allowed_videos']));
                          ...
                          <form action="" method="post">
                              ...
                              <div class="form-group mb-3">
                                  ...
                                  <input 
                                    ...
                                    name="allowed_days" 
                                    autocomplete="off"
                                    value="<?php if(isset($_POST['allowed_days'])) { echo $_POST['allowed_days']; } ?>"
                                  >
                              </div>
                              <div class="form-group mb-3">
                                  ...
                                  <input 
                                    ...
                                    autocomplete="off"
                                    value="<?php if(isset($_POST['allowed_properties'])) { echo $_POST['allowed_properties']; } ?>"
                                  >
                              </div>
                              <div class="form-group mb-3">
                                  ...
                                  <input 
                                    type="text" 
                                    class="form-control"
                                    name="allowed_featured_properties" 
                                    autocomplete="off"
                                    value="<?php if(isset($_POST['allowed_featured_properties'])) { echo $_POST['allowed_featured_properties']; } ?>"
                                  >
                              </div>
                              <div class="form-group mb-3">
                                  ...
                                  <input 
                                    ...
                                    name="allowed_photos" 
                                    autocomplete="off"
                                    value="<?php if(isset($_POST['allowed_photos'])) { echo $_POST['allowed_photos']; } ?>"
                                  >
                              </div>
                              <div class="form-group mb-3">
                                  ...
                                  <input 
                                    ...
                                    name="allowed_videos" 
                                    autocomplete="off"
                                    value="<?php if(isset($_POST['allowed_videos'])) { echo $_POST['allowed_videos']; } ?>"
                                  >
                              </div>
