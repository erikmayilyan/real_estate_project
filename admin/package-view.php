                                                  ...
                                                  <div class="modal-content">
                                                      ...
                                                      <div class="modal-body">
                                                          ...
                                                          <div class="form-group row bdb1 pt_10 mb_0">
                                                              ...
                                                              <div class="col-md-8">
                                                                <?php 
                                                                  if ($row['allowed_featured_properties'] == -1) {
                                                                ?>
                                                                    Unlimited
                                                                <?php
                                                                  } else {
                                                                    echo $row['allowed_featured_properties']; 
                                                                  }
                                                                ?>
                                                              </div>
                                                          </div>
                                                          <div class="form-group row bdb1 pt_10 mb_0">
                                                              ...
                                                              <div class="col-md-8">
                                                                <?php 
                                                                  if ($row['allowed_photos'] == -1) {
                                                                ?>
                                                                    Unlimited
                                                                <?php
                                                                  } else {
                                                                    echo $row['allowed_photos']; 
                                                                  }
                                                                ?>
                                                              </div>
                                                          </div>
                                                          <div class="form-group row bdb1 pt_10 mb_0">
                                                              ...
                                                              <div class="col-md-8">
                                                                <?php 
                                                                  if ($row['allowed_videos'] == -1) {
                                                                ?>
                                                                    Unlimited
                                                                <?php
                                                                  } else {
                                                                    echo $row['allowed_videos']; 
                                                                  }
                                                                ?>
                                                              </div>
                                                          </div>
