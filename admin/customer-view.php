                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered" id="example1">
                                ...
                                <tbody>
                                    <?php
                                      $i = 0;
                                      $statement = $conn->prepare("SELECT * FROM customers ORDER BY full_name ASC");
                                      $statement->execute();
                                      ...
                                      foreach ($result as $row) {
                                        ...
                                        <tr>
                                          ...
                                          <td class="pt_10 pb_10">
                                              <a href="<?php echo ADMIN_URL; ?>customer-delete.php?id=<?php echo $row['id']; ?>" class="btn btn-danger" onClick="return confirm('Are you sure?');">
