...
if (isset($_POST['form_submit'])) {
  try {
    ...
    $statement = $conn->prepare("SELECT * FROM locations WHERE slug=? AND id!=?");
    ...
    $statement = $conn->prepare("UPDATE locations SET name=?, slug=?, photo=? WHERE id=?");
    $statement->execute([$_POST['name'], $_POST['slug'], $filename, $_REQUEST['id']]);
                      ...
                      <div class="card-body">
                          <form action="" method="post" enctype="multipart/form-data">
                              ...
                              <div class="form-group mb-3">
                                ...
                                <div>
                                  <img
                                    src="<?php echo BASE_URL; ?>uploads/<?php echo $result[0]['photo']; ?>"
                                    class="w_200"
                                    alt=""
                                  />
                                </div>
