...
if (isset($_POST['form_submit'])) {
  try {
    ...
    $statement = $conn->prepare("UPDATE packages SET name=?, price=?, allowed_days=?, allowed_properties=?, allowed_featured_properties=?, allowed_photos=?, allowed_videos=? WHERE id=?");
    $statement->execute([$_POST['name'], $_POST['price'], $_POST['allowed_days'], $_POST['allowed_properties'], $_POST['allowed_featured_properties'], $_POST['allowed_photos'], $_POST['allowed_videos'], $_REQUEST['id']]);
                          ...
                          <form action="" method="post">
                              ...
                              <div class="form-group mb-3">
                                  ...
                                  <input 
                                    ...
                                    name="allowed_days" 
                                    autocomplete="off"
                                    value="<?php echo $result[0]['allowed_days']; ?>"
                                  >
                              </div>
                              <div class="form-group mb-3">
                                  ...
                                  <input 
                                    ...
                                    autocomplete="off"
                                    value="<?php echo $result[0]['allowed_properties']; ?>"
                                  >
                              </div>
                              <div class="form-group mb-3">
                                  ...
                                  <input 
                                    ...
                                    autocomplete="off"
                                    value="<?php echo $result[0]['allowed_featured_properties']; ?>"
                                  >
                              </div>
                              <div class="form-group mb-3">
                                  ...
                                  <input 
                                    ...
                                    name="allowed_photos" 
                                    autocomplete="off"
                                    value="<?php echo $result[0]['allowed_photos']; ?>"
                                  >
                              </div>
                              <div class="form-group mb-3">
                                  ...
                                  <input 
                                    ...
                                    name="allowed_videos" 
                                    autocomplete="off"
                                    value="<?php echo $result[0]['allowed_videos']; ?>"
                                  >
                              </div>
