                                      ...
                                      foreach ($result as $row) {
                                        ...
                                        <tr>
                                          ...
                                          <td class="pt_10 pb_10">
                                              ...
                                              <a href="<?php echo ADMIN_URL; ?>property-delete.php?id=<?php echo $row['id']; ?>" class="btn btn-danger btn-sm" onClick="return confirm('Are you sure?');">
                                                    ...
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            ...
                                                            <div class="form-group row bdb1 pt_10 mb_0">
                                                                ...
                                                                <div class="col-md-4 map1" style="transform: scale(0.5);">
                                                                  <?php echo $row['map']; ?>
                                                                </div>
                                                            </div>
                                                            <div class="form-group row bdb1 pt_10 mb_0">
                                                                ...
                                                                <div class="col-md-8">
                                                                    ...
                                                                    ?>
                                                                       <img src="<?php echo BASE_URL; ?>uploads/<?php echo $row1['photo']; ?>" alt="" class="w_100">
                                                                    <?php
                                                                     }
                                                                    ?>
                                                                </div>
