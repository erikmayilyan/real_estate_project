...
if (!isset($_REQUEST['id']) || !$_REQUEST['slug']) {
            ...
            <div class="col-lg-4 col-md-12">
                ...
                <div class="right-item">
                    ...
                    <div class="table-responsive mt_25">
                        <table class="table table-bordered">
                            ...
                            <?php };
                            if ($result[0]['facebook'] != '' && $result[0]['twitter'] != '' && $result[0]['linkedin'] != '' && $result[0]['pinterest'] != '' && $result[0]['instagram'] != '' && $result[0]['youtube'] != '') { ?>
                              <tr>
                                  <td>Social: </td>
                                  <td>
                                      <ul class="agent-ul">
                ...
                <div class="right-item">
                    ...
                    <div class="enquery-form">
                        <form action="<?php echo BASE_URL; ?>ajax-enquiry.php" method="post" class="form_enquiry">
