...
if ($total_properties == $allowed_properties) {
  $_SESSION['error_message'] = 'You have already added your maximum number of allowed proeprties. Please remove any of the added properties in order to add a new one.';
  header('Location: '.BASE_URL.'agent-properties');
  exit;
};

// Redirect to payment page, if the plan has expired
...
if (isset($_POST['form_submit'])) {
  try {
    ...
    if ($_POST['is_featured'] == 'Yes') {
      ...
      $statement = $conn->prepare("SELECT * FROM properties WHERE agent_id=? AND is_featured=?");
    ...
    $statement = $conn->prepare("INSERT INTO properties (
      agent_id, 
      location_id,
      type_id,
      amenities,
                    ...
                    <div class="row">
                            ...
                            <select name="location_id" class="form-control select2">
                                ...
                                ?>
                                  <option value="<?php echo $row['id']; ?>" 
                                    <?php if (isset($_POST['location_id']) && $_POST['location_id'] == $row['id']) { 
                                        echo 'selected'; 
                                    } ?>>
                                    <?php echo $row['name']; ?>
                                  </option>
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <select name="type_id" class="form-control select2">
                                ...
                                ?>
                                  <option value="<?php echo $row['id']; ?>" 
                                    <?php if (isset($_POST['type_id']) && $_POST['type_id'] == $row['id']) { 
                                            echo 'selected';
                                          } 
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <select name="purpose" class="form-control select2">
                                <option value="Sale" <?php if (isset($_POST['purpose']) && $_POST['purpose'] == 'Sale') { echo 'selected'; } ?>>Sale</option>
                                <option value="Rent" <?php if (isset($_POST['purpose']) && $_POST['purpose'] == 'Rent') { echo 'selected'; } ?>>Rent</option>
                            </select>
                        </div>
                        <div class="col-md-4 mb-3">
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="number" name="size" class="form-control" value="<?php if (isset($_POST['size'])) { echo $_POST['size']; }; ?>">
                        </div>
                        <div class="col-md-4 mb-3">
                            <label for="" class="form-label">Floor *</label>
                            <input type="number" name="floor" class="form-control" value="<?php if (isset($_POST['floor'])) { echo $_POST['floor']; }; ?>">
                        </div>
                        <div class="col-md-4 mb-3">
                            <label for="" class="form-label">Garage *</label>
                            <input type="number" name="garage" class="form-control" value="<?php if (isset($_POST['garage'])) { echo $_POST['garage']; }; ?>">
                        </div>
                        <div class="col-md-4 mb-3">
                            <label for="" class="form-label">Balcony *</label>
                            <input type="number" name="balcony" class="form-control" value="<?php if (isset($_POST['balcony'])) { echo $_POST['balcony']; }; ?>">
                        </div>
                        ...
                        <div class="col-md-12 mb-3">
                            ...
                            <textarea name="map" class="form-control h-150" cols="30" rows="10">
                              <?php if (isset($_POST['map'])) { echo $_POST['map']; }; ?>
                            </textarea>
                        </div>
                        <div class="col-md-4 mb-3">
                            <label for="" class="form-label">Is Featured? </label>
                            <select name="is_featured" class="form-control select2">
                                <option value="No" <?php if (isset($_POST['is_featured']) && $_POST['is_featured'] == 'No') { echo 'selected'; } ?>>No</option>
                                <option value="Yes" <?php if (isset($_POST['is_featured']) && $_POST['is_featured'] == 'Yes') { echo 'selected'; } ?>>Yes</option>
                            </select>
                        </div>
                        <div class="col-md-12 mb-3">
