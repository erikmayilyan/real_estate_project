...
$statement = $conn->prepare("SELECT * FROM locations WHERE slug=?");
...
<div class="page-top" style="background-image: url('<?php echo BASE_URL; ?>uploads/banner.jpg')">
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <h2>Location: <?php echo $l_name; ?></h2>
            </div>
        </div>
    </div>
</div> 
...
<div class="property">
    <div class="container">
        <div class="row">
            <?php 
            $expire_date = date('Y-m-d'); // Assuming expire_date is a date
            $currently_active = true; // Assuming currently_active is a boolean
            ...
            $statement->execute([$id, $expire_date, $currently_active]); // Passing additional variables for binding
            $result = $statement->fetchAll(PDO::FETCH_ASSOC);
                          ...
                          <div class="text">
                              ...
                              <div class="detail">
                                  ...
                                  <div class="agent-section">
                                    ...
                                    ?>
                                      <a href="<?php echo BASE_URL; ?>agent/<?php echo $row['agent_id']; ?>">
