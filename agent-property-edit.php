...
if (isset($_POST['form_submit'])) {
  try {
    ...
    $statement = $conn->prepare("UPDATE properties
                                 SET 
                                 location_id=?,
                                 type_id=?,
                                 amenities=?,
                    ...
                    <div class="row">
                            ...
                            <select name="location_id" class="form-control select2">
                                ...
                                ?>
                                  <option value="<?php echo $row['id']; ?>" 
                                    <?php if (isset($result[0]['location_id']) && $result[0]['location_id'] == $row['id']) { 
                                        echo 'selected'; 
                                    } ?>>
                                    <?php echo $row['name']; ?>
                                  </option>
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <select name="type_id" class="form-control select2">
                                ...
                                ?>
                                  <option value="<?php echo $row['id']; ?>" 
                                    <?php if (isset($result[0]['type_id']) && $result[0]['type_id'] == $row['id']) { 
                                            echo 'selected';
                                          } 
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <select name="purpose" class="form-control select2">
                                <option value="Sale" <?php if (isset($result[0]['purpose']) && $result[0]['purpose'] == 'Sale') { echo 'selected'; } ?>>Sale</option>
                                <option value="Rent" <?php if (isset($result[0]['purpose']) && $result[0]['purpose'] == 'Rent') { echo 'selected'; } ?>>Rent</option>
                            </select>
                        </div>
                        <div class="col-md-4 mb-3">
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="number" name="size" class="form-control" value="<?php echo $result[0]['size']; ?>">
                        </div>
                        <div class="col-md-4 mb-3">
                            <label for="" class="form-label">Floor *</label>
                            <input type="number" name="floor" class="form-control" value="<?php echo $result[0]['floor']; ?>">
                        </div>
                        <div class="col-md-4 mb-3">
                            <label for="" class="form-label">Garage *</label>
                            <input type="number" name="garage" class="form-control" value="<?php echo $result[0]['garage']; ?>">
                        </div>
                        <div class="col-md-4 mb-3">
                            <label for="" class="form-label">Balcony *</label>
                            <input type="number" name="balcony" class="form-control" value="<?php echo $result[0]['balcony']; ?>">
                        </div>
