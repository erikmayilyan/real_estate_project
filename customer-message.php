...
if (isset($_POST['form_submit'])) {
  try {
    ...
    $email_message = 'Customer '.$_SESSION['customer']['full_name'].' has sent you message. So please login to your account and check that.';
            ...
            <div class="col-lg-9 col-md-12">
                ...
                <div class="message-item message-item-main">
                    <div class="message-top">
                        ...
                        <div class="text">
                            <h6>
                                <?php echo $_SESSION['customer']['full_name']; ?>
