        ...
        <div class="row pricing">
          <?php
            ...
            foreach ($result as $row) {
              if ($row['allowed_properties'] == -1) {
                $number0 = 'Unlimited';
              } else {
                $number0 = $row['allowed_properties'];
              };
              ...
              <div class="col-lg-4 mb_30">
                  <div class="card mb-5 mb-lg-0">
                      <div class="card-body">
                          ...
                          <h4 class="card-day">
                            (<?php echo $row['allowed_days'] ?> Days)
                          </h4>
                          <hr />
                          <ul class="fa-ul">
                              <li>
                                  <span class="fa-li"><i class="fas fa-check"></i></span><?php echo $number0; ?> Properties Allowed
                              </li>
                              <li>
                                  <span class="fa-li">
                                    <i class="<?php echo $symbol1; ?>"></i>
                                  </span>
                                  <?php echo $number1; ?> Featured Property
                              </li>
                              <li>
                                  <span class="fa-li">
                                    <i class="<?php echo $symbol2; ?>"></i>
                                  </span>
                                  <?php echo $number2; ?> Photos per Property
                              </li>
                              <li>
                                  <span class="fa-li">
                                    <i class="<?php echo $symbol3; ?>"></i>
                                  </span>
